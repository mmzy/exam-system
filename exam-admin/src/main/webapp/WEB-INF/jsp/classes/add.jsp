...
<body>
<div class="pd-20">
    <form onsubmit="ajaxSubmitForm(this, true)" action="<%=path %>/classes/add" class="form form-horizontal">
    
        <div class="row cl">
            <label class="form-label col-2">班级名称</label>
            <div class="formControls col-5">
                <input type="text" class="input-text" name="classesname" />
            </div>
            <div class="col-5"></div>
        </div>
		...
		<div class="row cl">
            ...
            <div class="formControls col-5">
                <input type="text" class="input-text" name="grade" />
            </div>
            <div class="col-5"></div>
        </div>
