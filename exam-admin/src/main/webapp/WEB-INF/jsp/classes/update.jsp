...
<body>
<div class="pd-20">
    <form onsubmit="ajaxSubmitForm(this, true)" action="<%=path %>/classes/update" class="form form-horizontal">
        <input type="hidden" name="classesid" value="${classes.classesid }" />
        <div class="row cl">
            <label class="form-label col-2">班级名称</label>
            <div class="formControls col-5">
                <input type="text" class="input-text" name="classesname" value="${classes.classesname }" />
            </div>
            <div class="col-5"></div>
        </div>
		
		<div class="row cl">
            <label class="form-label col-2">所在年级</label>
            <div class="formControls col-5">
                <input type="text" class="input-text" name="grade" value="${classes.grade }" />
            </div>
            <div class="col-5"></div>
        </div>
