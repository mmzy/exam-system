...
<div class="pd-20">
    <div class="mt-20">
    <form action="<%=path%>/classesSubject/add">
            ...
            <tbody>
                  <c:forEach items="${pageInfo.list }" var="teacherSubject">
	       			<tr>
	                      ...
	                      <td>
	                          <button class="btn size-MINI radius" onclick="ajaxSubmit('<%=path%>/classesSubject/add', 'subId=${teacherSubject.subjectId }&classesId=${classesId }&teacherId=${teacherSubject.teacherId }')">添加到班级</button>
	                      </td>
	                  </tr>
                  </c:forEach>
