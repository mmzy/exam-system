...
<div class="pd-20">
    ...
    <form onsubmit="ajaxSubmitForm(this, true)" action="<%=path %>/subject/update" class="form form-horizontal">
        <div class="row cl">
            <label class="form-label col-2">学科名称</label>
            <div class="formControls col-5">
                <input type="text" class="input-text" id="name" name="name" value="${subject.name }" />
