...
<body>
<div class="pd-20">
    <form onsubmit="ajaxSubmitForm(this, true)" action="<%=path %>/teacher/add" class="form form-horizontal">
        <input type="hidden" name="id" value="1" />
        
        <div class="row cl">
            <label class="form-label col-2">教工号</label>
        ...
        <div class="row cl">
         ...
         <div class="row cl">
            ...
            <div class="formControls col-5">
                <input type="text" class="input-text" name="idcard" />
            </div>
            <div class="col-5"></div>
        </div>
