...
<body>
<div class="pd-20">
    <form onsubmit="ajaxSubmitForm(this, true)" action="<%=path %>/student/update" class="form form-horizontal">
        <input type="hidden"  name="id" value="${student.id }"/>

        <div class="row cl">
            <label class="form-label col-2">姓名</label>
            <div class="formControls col-5">
                <input type="text" class="input-text" name="name" value="${student.name }"/>
            </div>
            <div class="col-5"></div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-5">
                <input type="text" class="input-text" name="age" value="${student.age }"/>
            </div>
            <div class="col-5"></div>
        </div>
         ...
         <div class="row cl">
            ...
            <div class="formControls col-5">
                <input type="text" class="input-text" name="idcard" value="${student.idcard }"/>
            </div>
            <div class="col-5"></div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-5">
                <input type="text" class="input-text" name="qq"  value="${student.qq }"/>
            </div>
            <div class="col-5"></div>
        </div>
         ...
         <div class="row cl">
            ...
            <div class="formControls col-5">
                <input type="text" class="input-text" name="phone" value="${student.phone }"/>
            </div>
            <div class="col-5"></div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-5">
                <input type="text" class="input-text" name="email" value="${student.email }"/>
            </div>
            <div class="col-5"></div>
        </div> 
