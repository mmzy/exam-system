...
<div class="pd-20">
    <form action="">
        ...
        <div class="text-c"> 
            <input type="text" name="param" value="${params }" placeholder=" 学生姓名、学号、手机等" style="width:250px" class="input-text" />
        ...
        <table class="table table-border table-bordered table-bg table-hover">
            <thead>
                <tr>
                    ...
                    <th>手机</th>
                    <th>邮箱</th>
                    <th>操作<button class="btn size-M radius" onclick="showLayer('添加学员','<%=path%>/student/add')"> 添加</button></th>
                </tr>
            </thead>
            <tbody>
            	<c:forEach items="${pageInfo.list }" var="student">
                    <tr>
                        ...
                        <td>${student.email }</td>
                        <td>
                            <button class="btn size-MINI radius" onclick="showLayer('修改用户','<%=path%>/student/update?id=${student.id }')">修改</button>
                        </td>
                    </tr>
                  </c:forEach>
            </tbody>
