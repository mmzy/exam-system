...
<body>
<div class="pd-20">
    <form onsubmit="ajaxSubmitForm(this, true)" action="<%=path %>/chapter/update" class="form form-horizontal">
        <input type="hidden" id="id" name="id" value="${chapter.id }">
        <input type="hidden" id="subId" name="subId" value="${chapter.subId }">
        <div class="row cl">
            <label class="form-label col-2">篇章</label>
        ...
        <div class="row cl">
            <label class="form-label col-2">篇章标题</label>
            <div class="formControls col-5">
                <input type="text" class="input-text" name="title" value="${chapter.title }" />
            </div>
            <div class="col-5"></div>
        </div>
