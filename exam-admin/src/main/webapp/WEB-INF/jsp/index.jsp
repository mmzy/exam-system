...
<header class="Hui-header cl"> 
	...
	<ul class="Hui-userbar">
		<li class="dropDown dropDown_hover"><a class="dropDown_A">${adminInfo.name } <i class="Hui-iconfont">&#xe6d5;</i></a>
			<ul class="dropDown-menu radius box-shadow">
				<li><a onclick="showLayer('修改密码','<%=path%>/adminUser/updatePassword',600,371)">修改密码</a></li>
				<li><a href="<%=path%>/adminUser/logout">退出</a></li>
			</ul>
		</li>
    ...
    <aside class="Hui-aside">
    	...
    	<div class="menu_dropdown bk_2">
    		<dl id="menu-picture">
    			...
    			<dd>
    				<ul>
                        <li><a _href="<%=path%>/subject/list" href="javascript:;">学科管理</a></li>
    					<li><a _href="<%=path%>/student/list" href="javascript:void(0)">学生管理</a></li>
                        <li><a _href="<%=path%>/teacher/list" href="javascript:void(0)">老师管理</a></li>
                        <li><a _href="<%=path%>/classes/list" href="javascript:void(0)">班级管理</a></li>
                        ...
                        <li><a _href="<%=path%>/classesScore/list" href="javascript:void(0)">查询班级成绩</a></li> 			
    				</ul>
    			</dd>
    		</dl>
    		...
    		<dl id="menu-comments">
    			...
    			<dd>
    				<ul>
                        <li><a _href="<%=path%>/adminUser/teacherList" href="javascript:void(0)">老师管理</a></li> 					
    					<li><a _href="<%=path%>/adminUser/studentList" href="javascript:void(0)">学生管理</a></li>
    				</ul>
    			</dd>
    		</dl>
    	</div>
