...
<div class="pd-20">
    <div class="mt-20">
        <c:if test="${list != null }">
        <tr>
            <th>学号：${studentExamHis.studentid }&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
            <th>姓名：${studentExamHis.studentname }&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
            <th>班级：${studentExamHis.classesname }&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
        </tr>
	        <table class="table table-border table-bordered table-bg table-hover">
	            ...
	            <tbody>
	            	...
	            	<c:forEach items="${list }" var="examhise">
	                    <tr>
	                        <td>${examhise.subjectname }</td>
	                        <td><fmt:formatDate value="${examhise.examtime }" pattern="yyyy-MM-dd HH:mm:ss"/></td>
