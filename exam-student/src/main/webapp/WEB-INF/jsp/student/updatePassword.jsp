...
<body>
<div class="pd-20">
    <form onsubmit="ajaxSubmitForm(this, true)" action="<%=path %>/student/updatePassword" method="post" class="form form-horizontal">
    
        <div class="row cl">
            <label class="form-label col-2">旧密码</label>
            <div class="formControls col-5">
                <input type="password" class="input-text" name="password" />
                <input type="hidden" class="input-text" name="id" value="${studentInfo.id }"/>
            </div>
            <div class="col-5"></div>
        </div>
