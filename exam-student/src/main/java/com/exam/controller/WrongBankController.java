...
public class WrongBankController {
	...
	public String examWrongs(HttpServletRequest request,String studentId, int publishExamId,Model model){
		...
		model.addAttribute("textList", returnNote);
		return "/wrongBank/wrongs";
	}
