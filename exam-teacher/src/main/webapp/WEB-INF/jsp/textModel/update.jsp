...
<body>
<div class="pd-20">
    <form onsubmit="ajaxSubmitForm(this, true)" action="<%=path %>/textModel/update" class="form form-horizontal">
        <div class="row cl">
            <label class="form-label col-2">试题模块名称</label>
            <div class="formControls col-5">
            	<input type="hidden" id="id" name="id" value="${textmodel.id }">
                <input type="text" class="input-text" name="texttype" value="${textmodel.texttype }" />
            </div>
            <div class="col-5"></div>
        </div>
        <div class="row cl">
