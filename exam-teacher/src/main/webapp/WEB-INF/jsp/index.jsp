...
<header class="Hui-header cl"> 
	...
	<ul class="Hui-userbar">
		<li class="dropDown dropDown_hover"><a class="dropDown_A">${teacherInfo.name } <i class="Hui-iconfont">&#xe6d5;</i></a>
    ...
    <aside class="Hui-aside">
    	...
    	<div class="menu_dropdown bk_2">
    		...
    		<dl id="menu-comments">
    			...
    			<dd>
    				<ul>
                        <li><a _href="<%=path%>/text/list" href="javascript:void(0)">试题管理</a></li> 
                        <li><a _href="<%=path%>/textModel/list" href="javascript:void(0)">试题模块管理</a></li>
    				</ul>
    			</dd>
    		</dl>
