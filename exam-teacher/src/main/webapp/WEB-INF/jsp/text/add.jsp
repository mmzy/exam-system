...
<body>
<div class="pd-20">
    <form onsubmit="ajaxSubmitForm(this, true)" action="<%=path %>/text/add" class="form form-horizontal">
            ...
            <div class="formControls col-5">
                <select class="input-text" id="chapterid" name="chapterid">
                	<c:forEach items="${chapterList }" var="chapter">
                		<option value="${chapter.id }">${chapter.name } &nbsp;&nbsp;&nbsp; ${chapter.title }</option>
                	</c:forEach>
                </select>
            </div>
            <div class="col-5"></div>
            ...
            <div class="formControls col-5">
            	<select class="input-text" id="texId" name="texId">
                	<c:forEach items="${textModelList }" var="textModel">
                		<option value="${textModel.id }">${textModel.texttype }</option>
                	</c:forEach>
                </select>
            </div>
            <div class="col-5"></div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-5">
            <textarea name="title" class="textarea"></textarea>
            </div>
            <div class="col-5"></div>
        </div>
        ...
        <div class="row cl" id="type1">
            ...
            <div class="formControls col-5">
            	<input type="text" class="input-text"  name="type1" />
            </div>
            <div class="col-5"></div> 
        </div>
        ...
        <div class="row cl" id="type2">
            ...
            <div class="formControls col-5">
            	<input type="text" class="input-text" name="type2" />
            </div>
            <div class="col-5"></div> 
        </div>
        ...
        <div class="row cl" id="type3">
            ...
            <div class="formControls col-5">
            	<input type="text" class="input-text"  name="type3" />
            </div>
            <div class="col-5"></div> 
        </div>
        ...
        <div class="row cl" id="type4">
            ...
            <div class="formControls col-5">
            	<input type="text" class="input-text" name="type4" />
            </div>
            <div class="col-5"></div> 
        </div>
        ...
        <div class="row cl" id="type5">
            ...
            <div class="formControls col-5">
            	<input type="text" class="input-text" name="type5" />
            </div>
            <div class="col-5"></div> 
        </div>
        ...
        <div class="row cl" id="type6">
            ...
            <div class="formControls col-5">
            	<input type="text" class="input-text" name="type6" />
            </div>
            <div class="col-5"></div> 
        </div>
        ...
        <div class="row cl" id="type7">
            ...
            <div class="formControls col-5">
            	<input type="text" class="input-text" name="type7" />
            </div>
            <div class="col-5"></div> 
        </div>
