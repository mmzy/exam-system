        ...
        <tbody>
        	<c:forEach items="${pageInfo.list }" var="examhis">
	        	<tr>
	                ...
	                <td>
	                	<button class="btn size-MINI radius" onclick="showLayer('批阅试卷','<%=path%>/exam/examtest?studentid=${examhis.studentid }&publishexamid=${examhis.publishexamid }')">批阅试卷</button>  
	                </td>
	            </tr>
         	</c:forEach>      
        </tbody>
